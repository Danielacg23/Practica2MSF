...
fg2.savefig('sistema cardiovascular python.pdf')
...
fg3.tight_layout()
fg3.savefig('sistema cardiovascular python.png',dpi=600,bbox_inches='tight')

fg3.savefig('sistema cardiovascular python.pdf')
